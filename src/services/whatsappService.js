...
exports.processWhatsAppResponse = processWhatsAppResponse;
const axios_1 = __importDefault(require("axios"));
const main_1 = require("../main");
const Post_1 = require("../models/Post"); // Assuming your postService has a Post model
...
function sendWhatsAppMessage(title, content, images, postId) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield axios_1.default.post(WHATSAPP_API_URL, message, {
                headers: {
...
function processWhatsAppResponse(message) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (timeRegex.test(responseText)) {
            ...
            yield (0, linkedinService_1.handlePostTimeInput)(postId, message);
            return;
        }
        // --- Reject Flow -
